...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(discrete_state_input=False),         # 上一次训练没设置
    ...
    TrainConfig(
        ...
        data=CustomDataConfig(
            ...
            assets=AssetsConfig(assets_dir="/mnt/mnt/public/yiwei/assets"),
            extra_delta_transform=True,  # True for delta action, False for abs_action
            action_train_with_rotation_6d=False,  # User can add extra config in custom dataset
        ),
        pytorch_weight_path="/mnt/mnt/public/yiwei/pi0_base",
    ),
]
