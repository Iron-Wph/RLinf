...
def get_robotwin2_task(task_name, config):
    ...
    #assets_path = "/mnt/mnt/public/guozhen/test_robotwin/robotwin_assets"

    robotwin2_path = "/mnt/mnt/public/guozhen/test_robotwin/RLinf_RoboTwin"
    if robotwin2_path not in sys.path:
        sys.path.append(robotwin2_path)
        
    robotwin2_utils_path = "/mnt/mnt/public/guozhen/test_robotwin/RLinf_RoboTwin/description/utils"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tasks', nargs='+', 
                       choices=["adjust_bottle", "handover_mic", "move_can_pot", "pick_dual_bottles", 
