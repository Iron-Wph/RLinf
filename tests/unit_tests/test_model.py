...
DEFAULT_MODEL_DIR = "/mnt/public/wph/models/robotwin2_place_empty_cup_seed1k_sft_aloha_25chunks_10k"
DEFAULT_ASSETS_PATH = "/mnt/public/guozhen/test_robotwin/robotwin_assets"
DEFAULT_SEEDS_PATH = "/mnt/public/wph/codes/RLinf/examples/embodiment/seeds/robotwin2_eval_seeds.json"
...
def parse_args():
    ...
    parser.add_argument("--do-sample", default=False, help="Use stochastic sampling instead of greedy decoding.")
    parser.add_argument("--precision", default="bf16", help="Model precision passed to get_model.")
